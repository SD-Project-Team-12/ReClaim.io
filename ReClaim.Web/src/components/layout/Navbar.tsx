...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className={`xl:hidden fixed inset-0 bg-white/20 backdrop-blur-md transition-all duration-300 z-[998] ${
          isMobileMenuOpen
            ? "opacity-100 visible"
            : "opacity-0 invisible pointer-events-none"
        }`}
      ...
      <div
        className={`xl:hidden fixed top-0 right-0 h-[100dvh] w-[280px] bg-white shadow-[-20px_0_40px_rgba(0,0,0,0.08)] transform transition-transform duration-300 ease-out z-[999] flex flex-col rounded-l-3xl border-l border-slate-100 overflow-hidden ${
