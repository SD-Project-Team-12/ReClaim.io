...
export default function RequestPickUp({ onSuccess }: RequestFormProps) {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm ring-1 ring-slate-900/5 overflow-hidden flex flex-col lg:flex-row lg:h-[540px]">

            {/* LEFT SIDE: Compact Form */}
            <div className="w-full lg:w-1/2 p-5 border-b lg:border-b-0 lg:border-r border-slate-100 flex flex-col justify-between">
                                ...
                                {["Computing", "Mobile", "Appliances"].map((cat) => (
                                    <button
                                        ...
                                        className={`flex-1 text-xs font-semibold py-1.5 rounded-md transition-all ${
                                            formData.category === cat ? "bg-white shadow-sm text-emerald-600 ring-1 ring-slate-900/5" : "text-slate-500 hover:text-slate-700"
                                        }`}
                                    >
                            ...
                            <div className="flex bg-slate-100 p-1 rounded-lg">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 text-xs font-semibold py-1.5 rounded-md transition-all ${
                                            formData.condition === cond.val ? "bg-white shadow-sm text-emerald-600 ring-1 ring-slate-900/5" : "text-slate-500 hover:text-slate-700"
                                        }`}
                                    >
                                        {cond.label}
                                    </button>
                ...
                {/* Price Card */}
                <div className="mt-4 bg-slate-900 p-4 rounded-xl text-white shadow-inner flex justify-between items-center relative overflow-hidden shrink-0">
            ...
            <div className="w-full lg:w-1/2 h-64 lg:h-full bg-slate-100 relative z-0">
                ...
                {/* Floating Search Bar Overlay (CHANGED z-[400] to z-[1000]) */}
                ...
                {/* Floating Map Instructions (CHANGED z-[400] to z-[1000]) */}
